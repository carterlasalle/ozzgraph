...
- `e2e-output/raw_results.json` — per-check PASS/FAIL/UNTESTABLE with details (regenerated 2026-08-10).
- `e2e-output/forensic_analysis.json` — flag-material locations, event-type classification, graph entity list, state-dir sweep (regenerated 2026-08-10).
